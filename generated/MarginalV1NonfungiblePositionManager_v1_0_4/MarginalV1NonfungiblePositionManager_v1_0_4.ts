...
export class MarginalV1NonfungiblePositionManager_v1_0_4__freeInputParamsStruct extends ethereum.Tuple {
  get token0(): Address {
...
export class MarginalV1NonfungiblePositionManager_v1_0_4__igniteResult {
  value0: BigInt;
  value1: BigInt;
...
export class MarginalV1NonfungiblePositionManager_v1_0_4__igniteInputParamsStruct extends ethereum.Tuple {
  get token0(): Address {
    return this[0].toAddress();
  }
...
export class MarginalV1NonfungiblePositionManager_v1_0_4__positionsResult {
  value0: Address;
  value1: BigInt;
  value2: boolean;
  value3: BigInt;
...
export class MarginalV1NonfungiblePositionManager_v1_0_4 extends ethereum.SmartContract {
  static bind(address: Address): MarginalV1NonfungiblePositionManager_v1_0_4 {
    return new MarginalV1NonfungiblePositionManager_v1_0_4(
      "MarginalV1NonfungiblePositionManager_v1_0_4",
      address
    );
  }
  ...
  free(
    params: MarginalV1NonfungiblePositionManager_v1_0_4__freeInputParamsStruct
  ): BigInt {
  ...
  ignite(
    params: MarginalV1NonfungiblePositionManager_v1_0_4__igniteInputParamsStruct
  ): MarginalV1NonfungiblePositionManager_v1_0_4__igniteResult {
    let result = super.call(
      "ignite",
    ...
    return new MarginalV1NonfungiblePositionManager_v1_0_4__igniteResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new MarginalV1NonfungiblePositionManager_v1_0_4__igniteResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  positions(
    tokenId: BigInt
  ): MarginalV1NonfungiblePositionManager_v1_0_4__positionsResult {
    let result = super.call(
      "positions",
    ...
    return new MarginalV1NonfungiblePositionManager_v1_0_4__positionsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBoolean(),
      result[3].toBigInt(),
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MarginalV1NonfungiblePositionManager_v1_0_4__positionsResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBoolean(),
        value[3].toBigInt(),
